...
const getUniverseMedia = (
  ...
  return gamesV2ApiInstance.v2GamesUniverseIdMediaGet(universeId, {
...
const getPlaceDetails = (
  ...
  return gamesApiInstance.v1GamesMultigetPlaceDetailsGet(placeIds, {
    withCredentials: true,
  });
};
...
const getProductInfo = (
  ...
  return gamesApiInstance.v1GamesGamesProductInfoGet(universeIds, {
    withCredentials: true,
  });
};
...
const getGamePasses = (
  ...
  return gamePassesApiInstance.v1GamesUniverseIdGamePassesGet(
    universeId,
    sortOrder,
    limit,
    cursor
