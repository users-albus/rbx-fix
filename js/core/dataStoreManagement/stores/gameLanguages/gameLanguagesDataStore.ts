...
const getGameLanguageRolloutSettings =
  (): AxiosPromise<GameInternationalizationProvider.RobloxGameInternationalizationApiSupportedLanguagesMetadataResponse> => {
    return supportedLanguagesApiInstance.v1SupportedLanguagesMetadataGet({
...
const getGameLanguages = (
  ...
  return supportedLanguagesApiInstance.v1SupportedLanguagesGamesGameIdGet(
    gameId,
    { withCredentials: true }
  );
};
...
const getGameLanguagesV2 = (
  ...
  return supportedLanguagesV2ApiInstance.v2SupportedLanguagesGamesGameIdGet(
    gameId,
    { withCredentials: true }
  );
};
...
const getAutomaticTranslationStatus = (
  ...
  return supportedLanguagesApiInstance.v1SupportedLanguagesGamesGameIdAutomaticTranslationStatusGet(
    gameId,
    { withCredentials: true }
  );
};
...
const setAutomaticTranslationStatus = (
  ...
  return supportedLanguagesApiInstance.v1SupportedLanguagesGamesGameIdLanguagesLanguageCodeAutomaticTranslationStatusPatch(
    gameId,
    languageCode,
...
const getAutomaticTranslationSwitchesValues = (
  ...
  return supportedLanguagesApiInstance.v1SupportedLanguagesGamesGameIdUniverseDisplayInfoAutomaticTranslationSettingsGet(
    gameId,
    { withCredentials: true }
  );
};
...
const setAutomaticTranslationSwitchesValue = (
  ...
  return supportedLanguagesApiInstance.v1SupportedLanguagesGamesGameIdLanguagesLanguageCodeUniverseDisplayInfoAutomaticTranslationSettingsPatch(
    gameId,
    languageCode,
