...
const getGameFeatureStatus = (
  ...
  return automaticTranslationApiInstance.v1AutomaticTranslationGamesGameIdFeatureStatusGet(
    gameId,
    {
...
const getGameAutoLocalizationQuota = (
  ...
  return automaticTranslationApiInstance.v1AutomaticTranslationGamesGameIdQuotaGet(
    gameId,
    {
      withCredentials: true,
    }
