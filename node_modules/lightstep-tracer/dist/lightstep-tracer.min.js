    ...
    return function(t) {
        ...
        var i = function() {
            ...
            return n(t, [{
                ...
                value: function(t) {
                    (0, o.default)(this._baggage, function(e, r) {
                        t(r, e)
                    })
                }
            }, {
        ...
        var a = "ot-tracer-",
            ...
            c = function() {
                function t(e) {
                    ! function(t, e) {
                        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                    }(this, t), this._tracer = e, this._carrierPrefix = a, this._baggagePrefix = u
                }
                return n(t, [{
                    key: "inject",
                    value: function(t, e) {
        ...
        var o = function(t) {
            ...
            return n(e, t), e.prototype.span = function() {
                return this._span
            }, e
        }(r(2).SpanContext);
        ...
        var o = r(2),
            ...
            s = function(t) {
                ...
                return n(e, t), e.prototype._context = function() {
        ...
        ! function() {
            var e = {},
                r = {};
            void 0 === r && (r = {}), r.KeyValue = function(t) {
            ...
            }, r.KeyValue.prototype = {}, r.KeyValue.prototype.read = !1, r.KeyValue.prototype.write = !1, r.NamedCounter = function(t) {
            ...
            }, r.NamedCounter.prototype = {}, r.NamedCounter.prototype.read = !1, r.NamedCounter.prototype.write = !1, r.Runtime = function(t) {
            ...
            }, r.Runtime.prototype = {}, r.Runtime.prototype.read = !1, r.Runtime.prototype.write = !1, r.LogRecord = function(t) {
            ...
            }, r.LogRecord.prototype = {}, r.LogRecord.prototype.read = !1, r.LogRecord.prototype.write = !1, r.TraceJoinId = function(t) {
            ...
            }, r.TraceJoinId.prototype = {}, r.TraceJoinId.prototype.read = !1, r.TraceJoinId.prototype.write = !1, r.SpanRecord = function(t) {
            ...
            }, r.SpanRecord.prototype = {}, r.SpanRecord.prototype.read = !1, r.SpanRecord.prototype.write = !1, r.Auth = function(t) {
                this.access_token = null, t && void 0 !== t.access_token && (this.access_token = t.access_token)
            }, r.Auth.prototype = {}, r.Auth.prototype.read = !1, r.Auth.prototype.write = !1, r.Timing = function(t) {
            ...
            }, r.Timing.prototype = {}, r.Timing.prototype.read = !1, r.Timing.prototype.write = !1, r.SampleCount = function(t) {
            ...
            }, r.SampleCount.prototype = {}, r.SampleCount.prototype.read = !1, r.SampleCount.prototype.write = !1, r.MetricsSample = function(t) {
            ...
            }, r.MetricsSample.prototype = {}, r.MetricsSample.prototype.read = !1, r.MetricsSample.prototype.write = !1, r.Metrics = function(t) {
                this.counts = null, this.gauges = null, t && (void 0 !== t.counts && (this.counts = t.counts), void 0 !== t.gauges && (this.gauges = t.gauges))
            }, r.Metrics.prototype = {}, r.Metrics.prototype.read = !1, r.Metrics.prototype.write = !1, r.ReportRequest = function(t) {
            ...
            }, r.ReportRequest.prototype = {}, r.ReportRequest.prototype.read = !1, r.ReportRequest.prototype.write = !1, r.Command = function(t) {
                this.disable = null, t && void 0 !== t.disable && (this.disable = t.disable)
            }, r.Command.prototype = {}, r.Command.prototype.read = !1, r.Command.prototype.write = !1, r.ReportResponse = function(t) {
                this.commands = null, this.timing = null, t && (void 0 !== t.commands && (this.commands = t.commands), void 0 !== t.timing && (this.timing = t.timing))
            }, r.ReportResponse.prototype = {}, r.ReportResponse.prototype.read = !1, r.ReportResponse.prototype.write = !1, t.exports.crouton_thrift = r, t.exports.Thrift = {}
        }()
    }, function(t, e, r) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            ...
            E = function(t) {
                function e(t) {
                    ...
                    if (t && (o._transport = t.override_transport), o._propagators = {}, o._propagators[o._opentracing.FORMAT_HTTP_HEADERS] = new h.default(o), o._propagators[o._opentracing.FORMAT_TEXT_MAP] = new h.default(o), o._propagators[o._opentracing.FORMAT_BINARY] = new d.default(o, o._opentracing.FORMAT_BINARY), t && t.propagators && (o._propagators = n({}, o._propagators, t.propagators)), o._reportingLoopActive = !1, o._first_report_has_run = !1, o._reportYoungestMicros = i, o._reportTimer = null, o._reportErrorStreak = 0, o._lastVisibleErrorMillis = 0, o._skippedVisibleErrors = 0, o._activeRootSpanSet = {}, o._activeRootSpan = null, o._spanRecords = [], o._counters = {
                        ...
                        }, o._internalLogs = [], o._flushIsActive = !1, o.addPlugin(r(46)), o.addPlatformPlugins(t), o.setPlatformOptions(t), t && o.options(t), void 0 === o._transport || null === o._transport) switch (o._options.transport) {
                        case "thrift":
                ...
                return function(t, e) {
                    ...
                    value: function(t, e) {
                        ...
                        var p, _ = n ? n.traceGUID() : this.generateTraceGUIDForRootSpan(),
                            f = !n || n._sampled,
                            d = new a.default(this._platform.generateUUID(), _, f),
                            h = new u.default(this, t, d);
                        (h.addTags(this._options.default_span_tags), (0, c.default)(e, function(t, e) {
                            switch (e) {
                                case "references":
                                    break;
                                case "startTime":
                        ...
                        })), this.emit("start_span", h), S.shouldSendMetaSpan(this.options(), h.getTags())) && this.startSpan(O.LS_META_SP_START, {
                            tags: (p = {}, v(p, O.LS_META_EVENT_KEY, !0), v(p, O.LS_META_TRACE_KEY, h.traceGUID()), v(p, O.LS_META_SPAN_KEY, h.guid()), p)
                        }).finish();
                        return h
                    }
                }, {
                    ...
                    value: function(t, e, r) {
                        ...
                        var _, d = this._platform.nowMicros();
        ...
        var o = r(2),
            ...
            a = function(t) {
                ...
                return n(e, t), e.prototype._startSpan = function(t, e) {
        ...
        var o = r(9),
            ...
            a = new(function(t) {
                ...
                return n(e, t), e.prototype.startSpan = function() {
                    var t = s || i;
            ...
            return o(t, [{
                ...
                value: function() {
                    ...
                    return function(r, o, i, u, c) {
                        ...
                        o && (_.url_pathname = o.split("?")[0]);
                        var f = n({}, _);
                        l.include_cookies && (f.cookies = function() {
                ...
                value: function() {
                    ...
                    return function() {
                        ...
                        if (n.log({
                            ...
                            var c = {};
                            e.inject(n.context(), i.FORMAT_HTTP_HEADERS, c), Object.keys(c).forEach(function(t) {
            ...
            return n(t, [{
                ...
                value: function() {
                    var t = this,
                        e = this._tracer;
                    return function(r, n) {
                        var a = new Request(r, n),
                            u = e.options();
                        if (!t._shouldTrace(e, a.url)) return s(a);
                        ...
                        if (u.include_cookies && (p.cookies = function() {
                            ...
                            e.inject(c.context(), i.FORMAT_HTTP_HEADERS, _), Object.keys(_).forEach(function(t) {
                                a.headers.get(t) || a.headers.set(t, _[t])
                            })
                        }
                        return c.log({
                            event: "sending",
                            ...
                            url: a.url,
                            openPayload: p
                        }), c.addTags(p), s(a).then(function(t) {
        ...
        var i = function() {
            ...
            return n(t, [{
                ...
                value: function(t, e) {
                    var r = this;
                    t && (t.setTag("user_agent", navigator.userAgent), (0, o.default)(e, function(e, n) {
        ...
        var a = function() {
            ...
            return n(t, [{
                ...
                value: function() {
                    ...
                    var e = [];
                    return (0, i.default)(this._fields, function(r, n) {
                        if (n && r) {
        ...
        var a = function() {
            ...
            return n(t, [{
                ...
                value: function() {
                    var t = [];
                    return (0, i.default)(this._attributes, function(e, r) {
        ...
        var a = function() {
            ...
            return n(t, [{
                ...
                value: function() {
                    var t = this;
                    (0, i.default)(this._spanRecords, function(e) {
                        e.runtime_guid = t._runtimeGUID
                    });
                    var e = [];
                    (0, i.default)(this._counters, function(t, r) {
                    ...
                    var r = [];
                    return (0, i.default)(this._spanRecords, function(t) {
                        r.push(t._toThrift())
        ...
        var i = 7,
            ...
            a = function() {
                function t(e) {
                    ! function(t, e) {
                        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                    }(this, t), this._nowMicros = e.nowMicros, this._localStoreGet = e.localStoreGet, this._localStoreSet = e.localStoreSet, this._samples = [], this._currentOffsetMicros = 0, this._currentOffsetAge = i + 1;
                    var r = this._localStoreGet();
                    r && r.timestamp_micros && r.timestamp_micros > this._nowMicros() - s && (this._samples = r.samples.slice(-(i + 1))), this.update()
                }
                return n(t, [{
                    key: "addSample",
                    value: function(t, e, r, n) {
                        var o = Number.MAX_VALUE,
                            s = 0;
                        t > 0 && e > 0 && r > 0 && n > 0 && (o = n - t - (r - e), s = (e - t + (r - n)) / 2), this._samples.length === i + 1 && this._samples.shift(), this._samples.push({
                            delayMicros: o,
                            offsetMicros: s
                    ...
                    value: function() {
                        var t = Number.MAX_VALUE,
                            e = 0;
                        if ((0, o.default)(this._samples, function(r) {
                            ...
                            (this._currentOffsetAge > i || Math.abs(this._currentOffsetMicros - e) < 3 * r) && (this._currentOffsetMicros = e, this._currentOffsetAge = 0)
                        }
                    }
                }, {
                    key: "offsetMicros",
        ...
        var u = "x-datadog-",
            c = function() {
                function t(e) {
                    ! function(t, e) {
                        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                    }(this, t), this._tracer = e, this._baggagePrefix = s.default, this._carrierPrefix = u
                }
                return n(t, [{
                    key: "inject",
                    value: function(t, e) {
